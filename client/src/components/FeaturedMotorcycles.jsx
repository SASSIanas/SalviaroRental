...
const FeaturedMotorcycles = () => {
  ...
  // 🔹 Filter all categories starting with "motorcycle"
  const filtered = cars.filter(
    (car) => car.category && car.category.toLowerCase().startsWith('motorcycle')
  )
  ...
  return (
    <div className='flex flex-col items-center py-24 px-12 md:px-32 lg:px-40 xl:px-52'>
      <Title
        ...
        subTitle='Discover our range of motorcycles for thrill-seekers and adventurers.'
      />
